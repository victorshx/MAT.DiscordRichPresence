namespace MAT.DiscordRichPresence.Core
{
    class Const
    {
        public const string GAME_PROCESS = "MAT";
        public const string GAME_FULL_NAME = "Mission Against Terror 2";
        public const string GAME_SHORT_NAME = "MAT2";
        public const string DISCORD_APP_ID = "788058791710294029";
        public const string DISCORD_LARGE_IMAGE_KEY = "mat";
